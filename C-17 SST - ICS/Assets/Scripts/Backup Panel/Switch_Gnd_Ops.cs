...
public class Switch_Gnd_Ops : MonoBehaviour {
    ...
    public MCD_Fail_UI mcd_Fail_UI;
    ...
    void Update()
    {
        ...
        if (mcd_Fail_UI.ics == true) return;
    ...
    {
        if (mcd_Fail_UI.ics == true) mcd_Fail_UI.currentMode = MCD_Fail_UI.mode.ICS;
    ...
    private void MoveKnob()
    {
        switch (knob_pos)
        {
            ...
            default:
                this.transform.localEulerAngles = new Vector3(0.0f, 0.0f, -20.0f);
                mcd_Fail_UI.currentMode = MCD_Fail_UI.mode.ICS;
                initialPos.y = -1.0f;
                break;
        }
    }
