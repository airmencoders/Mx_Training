...
/// </summary>
public class btn_L4 : MonoBehaviour
{
    // Button Animation
    Vector3 startPos;
    Vector3 pushedPos;
    ...
    void OnMouseDown()
    {
        ...
        if (displayManager.CurrentMode == DisplayManager.mode.HF)
        {
            displayManager.HF_RadioSelect++;
            if (displayManager.HF_RadioSelect > 2) displayManager.HF_RadioSelect = 1;

        }
        else
        {
            displayManager.CurrentMode = DisplayManager.mode.HF;
        }
    }
}
